        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BilletPrice = table.Column<double>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BiletInOrders", x => new { x.BiletId, x.OrderId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BiletInShoppingCards", x => new { x.BiletId, x.ShoppingCartId });
                    table.ForeignKey(
                        name: "FK_BiletInShoppingCards_ShoppingCards_BiletId",
                        column: x => x.BiletId,
                        principalTable: "ShoppingCards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BiletInShoppingCards_Bilets_ShoppingCartId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BiletInShoppingCards_ShoppingCartId",
